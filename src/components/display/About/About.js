...
const About = props => {
	...
	return (
		<>
			...
			<div className={About}>
				<p>
					This project origins and base is the Burger Builder project
					from the{' '}
					<a href="https://www.udemy.com/react-the-complete-guide-incl-redux/">
						"React - The Complete Guide"
					</a>{' '}
					Udemy course, by Maximillian Schwartzmuler, showcasing an
					app built using React and the React ecosystem technologies.
				</p>
				<p>
				...
				<p>
					Also, sorry but there (probably) won't be real burgers, but
